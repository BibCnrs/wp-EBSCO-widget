    ...
    class EbscoWidget
    {
        ...
        protected function _enqueue()
        {
            ...
            if (!wp_style_is($this->tag, 'enqueued')) {
                ...
                wp_register_style(
                    $this->tag,
                    plugins_url('node_modules/ebsco-widget/build/app.css', __FILE__)
                );
            ...
            if (!wp_script_is($this->tag, 'enqueued')) {
                wp_register_script(
                    $this->tag,
                    plugins_url('node_modules/ebsco-widget/build/app.js', __FILE__),
                    array(),
                    $this->version,
                    true
                );
                wp_register_script(
                    $this->tag.'-index',
                    plugins_url("javascripts/index.js", __FILE__),
